            ...
            <div class="card">
                ...
                <div id="collapse<?= $node->Id ?>" class="collapse" aria-labelledby="heading<?= $node->Id ?>" data-parent="#accordionAuto">
                      ...
                      // var_dump($childs);
                        ...
                        <ul>
                            ...
                            <li>
                              ...
                              $allNodeChild= NodeAuto::getAllChildIds($c->Id);
                            $oemCode='';
                            foreach($oem as $i){
                                if ($i->IdNode == $child){
                                    $oemCode.=$i->OEM.','; 
                            ...
                            ?>
                                <?
                           // print_r($allNodeChild);
                            if (empty($allNodeChild)):
                            ?>
                    ...
                    ?>
                                ...
                                <ul>
                                    <?foreach($allNodeChild as $nodeChild):?>
                                    <li>
                                        <?
                                        $cn = NodeAuto::findOne($nodeChild);
                                        $oemCode='';
                                        foreach($oem as $i){
                                            if ($i->IdNode == $nodeChild){
                                                $oemCode.=$i->OEM.','; 
                                            }
                                        }
                                        ?>
