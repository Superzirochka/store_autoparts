...
if ($lang['Id'] == 1) {
    array_push($work, explode(',', $store->Work_time_ua, 18));
} else {
            ...
            <div class="col-sm-5  ">
                ...
                <div class="adres pl-5">
                    ...
                    <a href="viber://chat?number=%2B<?= $store->Viber ?>">
                        ...
                        <strong class=" font-italic ml-0">
                            Viber <?= preg_replace("/\s+/", "", $store->Viber) ?>
